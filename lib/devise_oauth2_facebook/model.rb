      ...
      module ClassMethods
        ...
        def create_person_fulldata(fb_user, token)
          ...
          begin
            ...
            person_f.opportunities.create(:estado => 'lead', :colores => '0', :precio_total => '0', :cantidad => '0', :facebook => 'http://www.facebook.com/'+fb_user.username, :notas => 'Creado con data de facebook!')
            person_f.save
